#version 460 core
in layout(location = 0) uint BlockType16_Brightness_Face3;
...
void main()
{
    uint BlockType = BlockType16_Brightness_Face3 >> 16;
    uint BrightnessBit = (BlockType16_Brightness_Face3 >> 15) & 0x1;
